...
const AIVoiceAssistant = ({ isOpen, onClose }) => {
    ...
    const knowledgeBase = {
        navigation: [
            ...
            { keywords: ['ecosystem', 'tool', 'predictor'], path: '/Ecosystem/', response: "I'm opening our ecosystem hub. Here you can find our AI Career Predictor, Counseling Portal, and other tools." },
