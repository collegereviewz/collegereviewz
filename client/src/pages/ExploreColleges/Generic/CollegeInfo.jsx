        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '220px 1fr', gap: '24px', alignItems: 'flex-start' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    ...
                    {/* 8. Location */}
                    <div id="location" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                        <div style={{ ...card, padding: '28px' }}>
                            <h2 style={{ fontSize: '18px', fontWeight: 900, color: '#1e293b', marginBottom: '12px' }}>{name} Location</h2>
                            <p style={{ fontSize: '13px', lineHeight: 1.9, color: '#475569', marginBottom: 0 }}>
                                Located at <strong>{location}</strong>. You can find detailed transit information below.
                            </p>
                        </div>
